...
struct KotlinConf : Event {
    ...
    var schedule: [Talk] {
        ...
        return [
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T08:00:00-07:00")!,
                 duration: 60,
                 title: "Registration",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T09:00:00-07:00")!,
                 duration: 60,
                 title: "Opening Keynote",
                 speaker: ["Andrey Breslav"],
                 track: Tracks.room1),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T10:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T10:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T11:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T11:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T12:00:00-07:00")!,
                 duration: 60,
                 title: "Lunch 🍽",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T13:00:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T13:45:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T14:00:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T14:45:00-07:00")!,
                 duration: 30,
                 title: "Break ☕️☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T15:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T16:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T16:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T17:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T17:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-02T18:05:00-07:00")!,
                 duration: 60,
                 title: "Party Keynote",
                 speaker: ["Michael Carducci"],
                 track: Tracks.room1),

            Talk(datestamp: dateFormatter.date(from: "2017-11-02T19:05:00-07:00")!,
                 duration: 180,
                 title: "Party 🎉",
                 speaker: [],
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T08:00:00-07:00")!,
                 duration: 60,
                 title: "Registration Day Two",
                 speaker: ["N/A"],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T09:00:00-07:00")!,
                 duration: 60,
                 title: "2nd Day Opening Keynote",
                 speaker: ["Erik Meijer"],
                 track: Tracks.room1),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T10:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T10:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T11:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-03T11:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T12:00:00-07:00")!,
                 duration: 60,
                 title: "Lunch 🍽",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T13:00:00-07:00")!,
                 duration: 45,
                 title: "TBA",
                 speaker: ["Andrey Breslav"],
                 track: Tracks.room1),
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T13:45:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-03T14:00:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T14:45:00-07:00")!,
                 duration: 30,
                 title: "Break ☕️☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-03T15:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T16:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),

            Talk(datestamp: dateFormatter.date(from: "2017-11-03T16:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T17:00:00-07:00")!,
                 duration: 15,
                 title: "Break ☕️",
                 speaker: [],
                 track: nil),
            
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T17:15:00-07:00")!,
                 duration: 45,
            ...
            Talk(datestamp: dateFormatter.date(from: "2017-11-03T18:05:00-07:00")!,
                 duration: 45,
                 title: "Closing Panel",
